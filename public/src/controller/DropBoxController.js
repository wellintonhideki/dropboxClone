class DropBoxController {
    ...
    constructor() {
        ...
        // selecionando os elementos - EL de elemento
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDsA7IOmxK1qosVBQuOezHjRuwyM9Gjlkw",
            authDomain: "dropbox-clone-bc54f.firebaseapp.com",
            databaseURL: "https://dropbox-clone-bc54f-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-bc54f",
            storageBucket: "dropbox-clone-bc54f.appspot.com",
            messagingSenderId: "796057127597",
            appId: "1:796057127597:web:758b0137da93ea8e7c9424",
            measurementId: "G-8XT6H9LFTV"
          };
          // Initialize Firebase
    ...
    initEvents(){
        ...
        this.btnSendFileEl.addEventListener('click', event => {
            ...
            // forçando o click no input
            this.inputFilesEl.click();

        });

        // change, quando alterar o input
        this.inputFilesEl.addEventListener('change', event => {

            this.btnSendFileEl.disabled = true;

            // targe.files onde estão os arquivos
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}){
        ...
        return new Promise((resolve,reject) => {
            ...
            // chamada quando a transação é concluída
            ajax.onload = event => {
            ...
            // caso ocorrer algum erro na requisição
            ajax.onerror = event => {
    
                reject(event);
            }
        
            // mostra o progresso do uploado do arquivo
    ...
    uploadTask(files){
        ...
        // como files é coleção, preciso do spread 
        [...files].forEach(file => {
            
            promises.push(new Promise((resolve, reject) => {

                // criando um arquivo dentro da referencia
                let fileRef = firebase.storage().ref(this.currentFolder.join('/')).child(file.name);

                // irá manipular o upload e retornar e eventos
    ...
    uploadProgress(event, file){
        ...
        // timestamp atual menos o timestamp da hora que começou o upload
    ...
    openFolder(){
        ...
        if (this.lastFolder) this.getFirebaseRef(this.lastFolder).off('value'); // desligando o evento da pasta anterior
    ...
    initEventsLi(li){
        ...
        li.addEventListener('click', e => {
            // caso pressione SHIFT
            if (e.shiftKey){

                // pegando o primeiro LI selecionado
                ...
                if (firstLi) {
                    ...
                    // acessando o pai, para percorrer os filhos
                    lis.forEach((el, index) => {

                        // pegando o primeiro e último selecionado
            ...
            // caso CTRL não estiver pressionado
            if (!e.ctrlKey){
    ...
    readFiles(){
        ...
        // evento value é disparado toda vez que há alteração nos dados do banco
